...
@section("body")
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-xl-6 d-flex flex-column align-items-center">
            <h2>Detalhes do Tipo de Uso da Terra</h2>
            ...
            <div class="row w-100 text-center align-items-center justify-content-center my-2">
                <div class="col-12">
                    <p class="my-1">
                        Descrição:
                        <span class="fw-bold">{{ $tipoUsoTerra->descricao }}</span>
                    </p>
                </div>
            </div>
            ...
            <div class="d-flex gap-4 mt-3">
                {{-- Editar --}}
                <a href="{{ route('tipoUsoTerra.edit', $tipoUsoTerra->id) }}"
                ...
                <form name="form_delete"
                      action="{{ route('tipoUsoTerra.destroy', $tipoUsoTerra->id) }}"
                      method="post">
                    @csrf
                    @method('DELETE')
                    <span class="w-100"
                          ...
                          onclick="botaoExcluir(this, `{{ $tipoUsoTerra->descricao }}`, 'Tipo de Uso da Terra')">
                        <button type="button"
                ...
                {{-- Voltar para lista --}}
                <a href="{{ route('tipoUsoTerra.index') }}"
