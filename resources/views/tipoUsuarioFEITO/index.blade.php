...
<h3>Consulta Tipos de Usuário</h3>
            ...
            <tr>
                ...
                <td class="text-center">
                    <form name="form_delete" action="{{ route('tipoUsuario.destroy',$tipoUsuario->id) }}" method="post">
                        @csrf
                        @method('DELETE')
                        <span data-bs-toggle="modal" data-bs-target="#mostrarModalExlusao" onclick="botaoExcluir(this, '{{ $tipoUsuario->descricao }}', 'Tipo Usuario')">
